...
# checkpoint = torch.load('./Results/resnet50/trained/backbone_50_trained.pth', map_location=torch.device('cpu'))
checkpoint = torch.load('./Results/resnet18/backbone_18_trained.pth')
